    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin">
                ...
                <div class="sidebar-brand-text mx-3">Ikost Admin</div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://i.pinimg.com/736x/e6/93/87/e69387e8def092153e6784e782a269b2.jpg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Ikost 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/customer/input" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                          <label for="biaya_kamar">Biaya Kamar</label>
                          <input type="text" class="form-control" name="biaya_kamar" id="biaya_kamar">
                        </div>
                    </div>
                <div class="modal-footer">
